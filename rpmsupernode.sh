...
ExecStart=/usr/sbin/geth --syncmode=full --cache=512 -node --lightserv 80 --lightpeers 100
...
sudo systemctl enable xerosupernode && systemctl stop xerosupernode && systemctl start xerosupernode
systemctl status xerosupernode --no-pager --full
